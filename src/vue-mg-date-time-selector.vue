<template>
    <div class="d-flex">
        ...
        <select class="form-control mr-1" style="width:5rem;" v-model="selected_year" :class="{ 'is-invalid': isInvalid }">
            <option></option>
            <option v-for="year in years" :key="year.value" :value="year.value">{{year.value}}</option>
        </select>
        <!-- <span class="align-self-center mx-1">年</span> -->
        <select class="form-control mr-1" style="width:4rem;"  v-model="selected_month" :class="{ 'is-invalid': isInvalid }">
            <option></option>
        ...
        <select class="form-control mr-2" style="width:4rem;"  v-model="selected_day" :class="{ 'is-invalid': isInvalid }">
            <option></option>
